...
public class CalenderConvertor {
	...
	public static String lunarToSolar(String lunarDate, boolean leapMonthFlag) throws Exception {
		...
		if(lunarDate != null)
		{
		 String[] dateList=	lunarDate.split(" ");
			if(dateList.length > 0) {
				minutes = dateList[1];
			}
		}
		lunarDate = shortDatatimeFormat(lunarDate);
		...
		return fullDatatimeFormat(formatter.format(myDate),minutes);
	...
	// 20180922 -- > 2015-09-22 00:00
	private static String fullDatatimeFormat(String solarDate, String minutes) throws Exception {
		String year = "";
		String month = "";
		String day = "";

		year = solarDate.substring(0, 4);
		month = solarDate.substring(4, 6);
		day = solarDate.substring(6, 8);

		return year + "-" + month + "-" + day + " " + minutes;
	}

	private static String shortDatatimeFormat(String lunarDate) throws Exception {
		String year = "";
		String month = "";
		String day = "";
		...
		String[] datetimeList = lunarDate.split(" ");
		String fullYear = "";

		if (datetimeList != null && datetimeList.length > 0) {
			fullYear = datetimeList[0];
			minutes = datetimeList[1];
		}

		if (fullYear != null) {
			String[] dateList = fullYear.split("-");
